...
class HyundaiLongitudinalBase(common.LongitudinalAccelSafetyTest):
  ...
  def test_cancel_button(self):
    """
      ...
      than dropping the authorisation on its own: openpilot disengages on the press and
      engages again on the next one. Turning MAIN off is what exits controls.
    """
    ...
    # MAIN on: the press keeps the authorisation so the next press can re-engage
