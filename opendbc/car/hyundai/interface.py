...
from opendbc.car.hyundai.radar_interface import CUSTIN_RADAR_START_ADDR, RADAR_START_ADDR
...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret: structs.CarParams, candidate, fingerprint, car_fw, alpha_long, is_release, docs) -> structs.CarParams:
    ...
    radar_start_addr = CUSTIN_RADAR_START_ADDR if ret.flags & HyundaiFlags.CUSTIN_RADAR else RADAR_START_ADDR
